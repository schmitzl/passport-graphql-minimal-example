(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('apollo-link'), require('apollo-utilities'), require('graphql-anywhere/lib/async')) :
	typeof define === 'function' && define.amd ? define(['exports', 'apollo-link', 'apollo-utilities', 'graphql-anywhere/lib/async'], factory) :
	(factory((global.errorLink = {}),global.apolloLink,global.apolloUtilities,global.graphqlAnywhere_lib_async));
}(this, (function (exports,apolloLink,apolloUtilities,graphqlAnywhere_lib_async) { 'use strict';
